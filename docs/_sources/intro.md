...
cd metodos_numericos_em_python
jupyter notebook
```

Os notebooks podem também ser executados diretamente no navegador via Binder ou Google Colab.

## Licença

Este material está disponível sob a licença [MIT](https://github.com/tiagoburiol/metodos_numericos_em_python/blob/main/LICENSE).
